  ...
  return (
    <Link className="card-element" href={`product/${identifier}`}>
      ...
      <div className="card-element__info">
        <h3 className="card-element__info-title">{title}</h3>
        <p className="card-element__info-subtitle">{subtitle}</p>
      </div>
      <span className="card-element__data">
        <span className="card-element__data-price">eur {displayPrice}</span>
        <span className="card-element__data-ref">ref. {ref}</span>
      </span>
    </Link>
  );
}
